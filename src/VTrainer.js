...
export default class STrainer extends React.Component {
            ...
            <div>
                <div className="strainer" style={{
                    ...
                    <div className={"kek"} ref={this.circleRef} style={{
                        ...
                        <div style={{
                            backgroundColor: '#35393E', width: 100, height: 100, borderRadius: 50, alignSelf: 'center', display: 'flex', justifyContent: 'center',
                            alignItems: 'center'
                        }}>
                            <div style={{
                                width: 60, height: 60, borderRadius: 30, background: '#E51A1A', boxShadow: '0px 2px 32px #FF1E1C, 0px 2px 5px rgba(238, 57, 0, 0.1)',
                                border: '1px solid #AA1313', display: 'flex', justifyContent: 'center', alignItems: 'center'
                            }}>
                                <div style={{ background: `url(${lines}) no-repeat`, backgroundSize: 50, width: 50, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={this.start()}>
